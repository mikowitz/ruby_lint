...
* If .rubocop.yml contains configuration for a custom cop, no warning regarding "unknown cop" will be printed. The custom cop must inherit from RubyLint::Cop::Cop, and must be loaded into memory for this to work. ([@alexdowad][])
