...
module CopHelper
  ...
  def inspect_source(source, file = nil)
    RubyLint::Formatter::DisabledConfigFormatter.config_to_allow_offenses = {}
  ...
  def parse_source(source, file = nil)
    ...
    RubyLint::ProcessedSource.new(source, ruby_version, file)
  end
  ...
  def _investigate(cop, processed_source)
    team = RubyLint::Cop::Team.new([cop], nil, raise_error: true)
