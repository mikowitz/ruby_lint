  ...
  module RSpec
    ...
    module ExpectOffense
      ...
      def expect_offense(source, file = nil, **replacements)
        ...
        RubyLint::Formatter::DisabledConfigFormatter
          .config_to_allow_offenses = {}
        RubyLint::Formatter::DisabledConfigFormatter.detected_styles = {}
      ...
      def expect_correction(correction, loop: true)
        ...
        new_source = loop do
          ...
          corrector =
            RubyLint::Cop::Corrector.new(@processed_source.buffer, cop.corrections)
          ...
          if iteration > RubyLint::Runner::MAX_ITERATIONS
            raise RubyLint::Runner::InfiniteCorrectionLoop.new(@processed_source.path, [])
          end
      ...
      class AnnotatedSource
        ...
        #
        # @param offenses [Array<RubyLint::Cop::Offense>]
        #
        # @return [self]
