...
RSpec.describe RubyLint::Cop::Registry do
  subject(:registry) { described_class.new(cops, options) }

  let(:cops) do
    [
      RubyLint::Cop::Lint::BooleanSymbol,
      RubyLint::Cop::Lint::DuplicateMethods,
      RubyLint::Cop::Layout::FirstArrayElementIndentation,
      RubyLint::Cop::Metrics::MethodLength,
      RubyLint::Cop::RSpec::Foo,
      RubyLint::Cop::Test::FirstArrayElementIndentation
    ]
  end
  ...
  before do
    stub_const('RubyLint::Cop::Test::FirstArrayElementIndentation', Class.new(RubyLint::Cop::Cop))
    stub_const('RubyLint::Cop::RSpec::Foo', Class.new(RubyLint::Cop::Cop))
  end

  # `RubyLint::Cop::Cop` mutates its `registry` when inherited from.
  ...
  it 'can be cloned' do
    klass = ::RubyLint::Cop::Metrics::AbcSize
    copy = registry.dup
    copy.enlist(klass)
  ...
  context 'when dismissing a cop class' do
    let(:cop_class) { ::RubyLint::Cop::Metrics::AbcSize }
  ...
  describe '#qualified_cop_name' do
    ...
    it 'raises an error when a cop name is ambiguous' do
      ...
      expect { registry.qualified_cop_name(cop_name, origin) }
        .to raise_error(RubyLint::Cop::AmbiguousCopName)
        .with_message(
  ...
  it 'exposes a mapping of cop names to cop classes' do
    expect(registry.to_h).to eql(
      'Lint/BooleanSymbol' => [RubyLint::Cop::Lint::BooleanSymbol],
      'Lint/DuplicateMethods' => [RubyLint::Cop::Lint::DuplicateMethods],
      'Layout/FirstArrayElementIndentation' => [
        RubyLint::Cop::Layout::FirstArrayElementIndentation
      ],
      'Metrics/MethodLength' => [RubyLint::Cop::Metrics::MethodLength],
      'Test/FirstArrayElementIndentation' => [
        RubyLint::Cop::Test::FirstArrayElementIndentation
      ],
      'RSpec/Foo' => [RubyLint::Cop::RSpec::Foo]
    )
  end
  ...
  describe '#enabled' do
    ...
    it 'selects only safe cops if :safe passed' do
      ...
      expect(enabled_cops).not_to include(RubyLint::Cop::RSpec::Foo)
    end
    ...
    context 'when new cops are introduced' do
      ...
      it 'does not include them' do
        ...
        expect(result).not_to include(RubyLint::Cop::Lint::BooleanSymbol)
      end
      ...
      context 'when specifying `--enable-pending-cops` command-line option' do
        ...
        it 'includes them' do
          result = registry.enabled(config, [])
          expect(result).to include(RubyLint::Cop::Lint::BooleanSymbol)
        end
