...
RSpec.describe RubyLint::Cop::Cop, :config do
  let(:location) do
    source_range(0...1)
  end
  ...
  describe 'for a cop with a name' do
    let(:cop_class) { RubyLint::Cop::Style::For }
  ...
  describe 'setting of Offense#corrected attribute' do
    ...
    context 'when cop supports autocorrection' do
      let(:cop_class) { RubyLint::Cop::Style::Alias }
  ...
  context 'with lint cops' do
    let(:cop_class) { RubyLint::Cop::Lint::Loop }
