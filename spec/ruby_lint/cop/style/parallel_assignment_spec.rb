...
RSpec.describe RubyLint::Cop::Style::ParallelAssignment, :config do
  let(:config) do
    RubyLint::Config.new('Layout/IndentationWidth' => { 'Width' => 2 })
  end
  ...
  describe 'autocorrect' do
    ...
    describe 'using custom indentation width' do
      let(:config) do
        RubyLint::Config.new('Performance/ParallelAssignment' => {
                              'Enabled' => true
                            },
