...
RSpec.describe RubyLint::Cop::Layout::ArgumentAlignment do
  subject(:cop) { described_class.new(config) }

  let(:config) do
    RubyLint::Config.new('Layout/ArgumentAlignment' => cop_config,
  ...
  context 'aligned with fixed indentation' do
    ...
    context 'assigned methods' do
      ...
      context 'with ArgumentAlignment:IndentationWidth set to 4' do
        let(:config) do
          RubyLint::Config.new('Layout/ArgumentAlignment' =>
