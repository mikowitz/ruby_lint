...
RSpec.describe RubyLint::Config do
  include FileHelper
  ...
  describe '#validate', :isolated_environment do
    subject(:configuration) do
      ...
      RubyLint::ConfigLoader.load_file(configuration_path)
    end
    ...
    context 'when the configuration includes an empty section' do
      ...
      it 'raises validation error' do
        expect { configuration.validate }
          .to raise_error(RubyLint::ValidationError,
    ...
    context 'when the empty section is AllCops' do
      ...
      it 'raises validation error' do
        expect { configuration.validate }
          .to raise_error(RubyLint::ValidationError, /^empty section AllCops/)
      end
    end
      ...
      before do
        create_file(configuration_path, <<~YAML)
          InvalidProperty:
            Enabled: true
        YAML
        stub_const('RubyLint::ConfigLoader::RUBY_LINT_HOME', rubocop_home_path)
      end
    ...
    context 'when the configuration includes an invalid EnforcedStyle' do
      ...
      it 'raises validation error' do
        expect { configuration.validate }
          .to raise_error(RubyLint::ValidationError, /itisinvalid/)
      end
    end
    ...
    context 'when the configuration includes multiple valid enforced styles '\
      ...
      it 'raises validation error' do
        expect { configuration.validate }
          .to raise_error(RubyLint::ValidationError, /trailing_comma/)
      end
    end
    ...
    context 'when the configuration includes multiple '\
      ...
      it 'raises validation error' do
        expect { configuration.validate }
          .to raise_error(RubyLint::ValidationError, /space/)
      end
    end
    ...
    context 'when the configuration includes an obsolete parameter' do
      ...
      it 'raises validation error' do
        expect { configuration.validate }
          .to raise_error(RubyLint::ValidationError, /EnforcedStyle/)
      end
    end
    ...
    context 'when the configuration includes obsolete parameters and cops' do
      ...
      it 'raises validation error' do
        ...
        expect { configuration.validate }
          .to raise_error(RubyLint::ValidationError, message_matcher)
      end
    end
