...
RSpec.describe RubyLint::Runner, :isolated_environment do
  describe 'how formatter is invoked' do
    ...
    subject(:runner) { described_class.new({}, RubyLint::ConfigStore.new) }

    let(:formatter) do
      instance_double(RubyLint::Formatter::BaseFormatter).as_null_object
    end
    ...
    describe 'invocation order' do
      let(:formatter) do
        formatter = instance_spy(RubyLint::Formatter::BaseFormatter)
