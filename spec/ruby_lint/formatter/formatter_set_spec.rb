...
RSpec.describe RubyLint::Formatter::FormatterSet do
  ...
  describe 'add_formatter' do
    ...
    it 'adds a formatter with specified formatter type' do
      ...
      expect(formatter_set.first.class)
        .to eq(RubyLint::Formatter::SimpleTextFormatter)
    end
    ...
    it 'can add multiple formatters by being invoked multiple times' do
      ...
      expect(formatter_set[1].class)
        .to eq(RubyLint::Formatter::EmacsStyleFormatter)
    end
  ...
  describe '#custom_formatter_class' do
    ...
    it 'can handle namespaced constant name' do
      expect(custom_formatter_class('RubyLint::CLI')).to eq(RubyLint::CLI)
    end
    ...
    context 'when non-existent constant name is passed' do
      it 'raises error' do
        expect { custom_formatter_class('RubyLint::NonExistentClass') }
