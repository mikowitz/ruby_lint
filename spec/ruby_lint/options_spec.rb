...
RSpec.describe RubyLint::Options, :isolated_environment do
  include FileHelper
    ...
    describe '-h/--help' do
      ...
      it 'shows help text' do
        ...
        expected_help = <<~OUTPUT
          Usage: rubocop [options] [file1, file2, ...]
              -L, --list-target-files          List all files RubyLint will inspect.
      ...
      it 'lists all builtin formatters' do
        ...
        expected_formatter_keys =
          RubyLint::Formatter::FormatterSet::BUILTIN_FORMATTERS_FOR_KEYS
          .keys.sort
    ...
    describe 'incompatible cli options' do
      it 'rejects using -v with -V' do
        ...
        expect { options.parse %w[-vV] }
          .to raise_error(RubyLint::OptionArgumentError, msg)
      end
