...
task generate_cops_documentation: :yard_for_generate_documentation do
  ...
  def configurable_values(pars, name)
    case name
    when /^Enforced/
      supported_style_name = RubyLint::Cop::Util.to_supported_styles(name)
  ...
  def references(config, cop)
    ...
    urls = RubyLint::Cop::MessageAnnotator.new(
  ...
  def main
    ...
    config = RubyLint::ConfigLoader.default_configuration
